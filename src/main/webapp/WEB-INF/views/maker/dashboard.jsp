...
<div class="d-flex flex-column" style="height: calc(100vh - 56px);">
    ...
    <div class="d-flex flex-column flex-grow-1 justify-content-center align-items-center">
        <div class="d-flex flex-column gap-3 w-100" style="max-width: 380px;">
            ...
            <a href="${newLoanUrl}"
               class="btn btn-white border border-primary rounded-3 shadow-sm d-flex align-items-center p-3 text-primary card-btn w-100 fs-5">
            ...
            <a href="${loanApplicationsUrl}"
               class="btn btn-white border border-secondary rounded-3 shadow-sm d-flex align-items-center p-3 text-secondary card-btn w-100 fs-5">
