            ...
            <form action="${newCustomerUrl}" method="get" id="customerTypeForm">
                ...
                <div class="mb-3">
                    <div class="form-check">
                        <input id="applicantTypeNew" name="applicantType" class="form-check-input" type="radio" value="NEW_CUSTOMER"
                               <c:if test="${empty sessionScope.loanApplication}">checked</c:if> />
                    ...
                    <div id="newCustomerOptions" class="ms-4 mt-2">
                        <div class="form-check mb-2">
                            <input id="customerTypeIndividual" name="newCustomerType" class="form-check-input" type="radio"
                                   value="INDIVIDUAL"/>
                        ...
                        <div class="form-check mb-2">
                            <input id="customerTypeNonIndividual" name="newCustomerType" class="form-check-input" type="radio"
                ...
                <div class="form-check">
                    <input id="applicantTypeExisting" name="applicantType" class="form-check-input" type="radio" value="EXISTING_CUSTOMER"
                           <c:if test="${not empty sessionScope.loanApplication}">checked</c:if> />
            ...
            <div id="existingCustomerBlock" class="border rounded p-3 bg-white mt-3 <c:if test='${empty loan}'>d-none</c:if>">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check form-check-inline">
                        <input id="customerTypeSearchIndividual" name="existingCustomerType" class="form-check-input" type="radio"
                               value="INDIVIDUAL" checked/>
                        <label class="form-check-label" for="customerTypeSearchIndividual">Individual</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input id="customerTypeSearchNonIndividual" name="existingCustomerType" class="form-check-input" type="radio"
                               value="NON_INDIVIDUAL"/>
                ...
                <form id="searchCustomerForm" action="${existingCustomerUrl}" method="post" class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input id="applicationNumber" name="applicationNumber" class="form-control" type="text"
                               placeholder="Enter Application ID / Deal ID"
                               value="<c:out value='${sessionScope.loanApplication.applicationNumber}'/>"/>
                    </div>
                    <div class="col-md-6">
                        <label for="applicationStatus" class="form-label">Status</label>
                        <input id="applicationStatus" name="applicationStatus" class="form-control bg-light fw-bold text-primary"
                               type="text" placeholder="Status" readonly
                               value="<c:out value='${not empty sessionScope.loanApplication.status ? sessionScope.loanApplication.status : ""}'/>"/>
                    </div>
                    <div class="col-12">
