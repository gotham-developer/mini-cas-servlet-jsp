                ...
                <section id="personalInformationSection" class="mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label for="applicantGender" class="form-label">Applicant's Gender <span
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <!-- Editable dial code -->
                                        <input type="text" id="dialCode" name="dialCode" class="form-control" value="+91"
                                               style="max-width: 90px;">

                                        <!-- Phone number -->
                                        <input type="text" id="contactNumber" name="contactNumber" class="form-control" minlength="4"
                                               maxlength="20" placeholder="Mobile Phone">
                                    </div>
                                </div>
                ...
                <section id="addressInformationSection" class="mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label for="flatPlotNumber" class="form-label">Flat / Plot Number <span
                                            class="text-danger">*</span></label>
