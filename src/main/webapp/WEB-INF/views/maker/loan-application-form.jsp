                ...
                <section class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="application-id" name="applicationID" class="form-control w-75"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="amount-requested" name="loanAmount" class="form-control"
                                           placeholder="Amount Requested" required>
                                </div>
                            </div>
